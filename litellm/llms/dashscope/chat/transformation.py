...
class DashScopeChatConfig(OpenAIGPTConfig):
    def remove_cache_control_flag_from_messages_and_tools(
        ...
        # `cache_control: {"type": "ephemeral"}` marker on message content
        # blocks to trigger explicit context cache. Unlike the base OpenAI
        # config (which strips it before sending), we pass it through.
